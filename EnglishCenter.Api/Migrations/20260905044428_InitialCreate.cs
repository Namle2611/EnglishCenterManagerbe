        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Courses_DurationMonths", "[DurationMonths] > 0");
                    table.CheckConstraint("CK_Courses_TuitionFee", "[TuitionFee] >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Sections_OrderIndex", "[OrderIndex] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentLevel = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Teachers_ExperienceYears", "[ExperienceYears] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Lessons_OrderIndex", "[OrderIndex] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseId = table.Column<int>(type: "int", nullable: false),
                    TuitionAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    EnrollmentDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Enrollments_TuitionAmount", "[TuitionAmount] >= 0");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Enrollments_Users_ConfirmedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ClassCode = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    CourseId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Classes_Dates", "[EndDate] > [StartDate]");
                    table.CheckConstraint("CK_Classes_MaxStudents", "[MaxStudents] > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Assignments_MaxScore", "[MaxScore] > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AttendanceSessions_Teachers_CreatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClassStudents_Enrollments_EnrollmentId",
                        column: x => x.EnrollmentId,
                        principalTable: "Enrollments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentId = table.Column<int>(type: "int", nullable: false),
                    ClassId = table.Column<int>(type: "int", nullable: false),
                    AttendanceScore = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Grades_AssignmentScore", "[AssignmentScore] IS NULL OR ([AssignmentScore] >= 0 AND [AssignmentScore] <= 10)");
                    table.CheckConstraint("CK_Grades_AttendanceScore", "[AttendanceScore] IS NULL OR ([AttendanceScore] >= 0 AND [AttendanceScore] <= 10)");
                    table.CheckConstraint("CK_Grades_FinalScore", "[FinalScore] IS NULL OR ([FinalScore] >= 0 AND [FinalScore] <= 10)");
                    table.CheckConstraint("CK_Grades_MidtermScore", "[MidtermScore] IS NULL OR ([MidtermScore] >= 0 AND [MidtermScore] <= 10)");
                    table.CheckConstraint("CK_Grades_QuizScore", "[QuizScore] IS NULL OR ([QuizScore] >= 0 AND [QuizScore] <= 10)");
                    table.CheckConstraint("CK_Grades_TotalScore", "[TotalScore] IS NULL OR ([TotalScore] >= 0 AND [TotalScore] <= 10)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Quizzes_Dates", "[StartAt] IS NULL OR [EndAt] IS NULL OR [EndAt] > [StartAt]");
                    table.CheckConstraint("CK_Quizzes_DurationMinutes", "[DurationMinutes] IS NULL OR [DurationMinutes] > 0");
                    table.CheckConstraint("CK_Quizzes_MaxAttempts", "[MaxAttempts] >= 1");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Schedules_DayOfWeek", "[DayOfWeek] >= 1 AND [DayOfWeek] <= 7");
                    table.CheckConstraint("CK_Schedules_Times", "[EndTime] > [StartTime]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Questions_OrderIndex", "[OrderIndex] >= 0");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_QuizAttempts_AttemptNumber", "[AttemptNumber] >= 1");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_QuestionOptions_OrderIndex", "[OrderIndex] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScoreEarned = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassStudents_EnrollmentId",
                table: "ClassStudents",
                column: "EnrollmentId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enrollments_ConfirmedBy",
                table: "Enrollments",
                column: "ConfirmedBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Grades_StudentId_ClassId",
                table: "Grades",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_ReceiverId_IsRead_CreatedAt",
                table: "Notifications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_EnrollmentId_Status",
                table: "Payments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Schedules_ClassId_RoomId_DayOfWeek",
                table: "Schedules",
                columns: new[] { "ClassId", "RoomId", "DayOfWeek" });
